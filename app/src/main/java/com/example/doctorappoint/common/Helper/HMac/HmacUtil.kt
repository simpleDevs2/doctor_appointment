package com.example.doctorappoint.common.Helper.HMac
...
object HMacUtil {
    ...
    val HMACS = LinkedList<String>(Arrays.asList("UnSupport", "HmacSHA256", "HmacMD5", "HmacSHA384", "HMacSHA1", "HmacSHA512"))
    ...
    fun HMacBase64Encode(algorithm: String, key: String, data: String): String? {
        ...
        return if (hmacEncodeBytes == null) {
            null
        } else {
            Base64.getEncoder().encodeToString(hmacEncodeBytes)
        }
    }
    ...
    fun HMacHexStringEncode(algorithm: String, key: String, data: String): String? {
        ...
        return if (hmacEncodeBytes == null) {
            ...
            HexStringUtil.byteArrayToHexString(hmacEncodeBytes)
        }
    }
}